...
CREATE TABLE Division (
  DivisionId PRIMARY KEY NOT NULL,
...
CREATE TABLE Upazilas (
  UpazilaId int PRIMARY KEY NOT NULL,
  DistrictId int FOREIGN KEY REFERENCES Districts(DistrictId) NOT NULL,
  UpazilaName varchar(25) NOT NULL,
  bn_name varchar(25) NOT NULL,
  url varchar(50) NOT NULL
) ;
